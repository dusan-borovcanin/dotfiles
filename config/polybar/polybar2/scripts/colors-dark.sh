...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #1D1F28/g' $PDIR/config.ini
